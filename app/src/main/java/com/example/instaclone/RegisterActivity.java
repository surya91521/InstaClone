                ...
                .addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            hashMap.put("bio"," ");
                            hashMap.put("imageUrl","https://firebasestorage.googleapis.com/v0/b/instaclone-841d1.appspot.com/o/icons8-user-96.png?alt=media&token=448506b4-3d89-497c-b0fb-00df82b7f797");
